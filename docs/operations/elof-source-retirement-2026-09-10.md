...
- `guide:gd_3y_social`: `cdc-milestones-3-years-2026` supports the exact three-year
  social milestone, peer play, friendship, getting along and act-early referral.
  The guide was narrowed to those exact claims instead of reusing older frozen
  source records beyond their recorded scopes. The existing current choking
