...
const NUTRITION_SLEEP_SAFETY: NutritionSleepSafety[] = [
  ...
  ['2y', 'nutrition',
    ...
    b('ဤအရွယ်တွင် စားစရာ ရွေးချယ်စားခြင်းသည် အလွန်ပုံမှန် ဖြစ်ပြီး ကိုယ်တိုင်ဆန္ဒဖော်ပြနိုင်မှု ကြီးထွားလာခြင်းကို ပြသည်။', 'Picky eating is very common and normal at this age — it reflects a growing sense of independence and preference.'),
...
const GAP_FILL: GapFill[] = [
  ...
  ['2_5y', 'play', 1,
    ...
    b('ပစ္စည်းတစ်ခုကို အခြားအရာအဖြစ် စိတ်ကူးဖြင့် အစားထိုးနိုင်ခြင်းသည် သင်္ကေတဆိုင်ရာ တွေးခေါ်မှု၏ အရေးကြီးသော အဆင့်ဖြစ်သည်။', 'Letting one object represent another in the imagination is an important step in symbolic thinking.'),
