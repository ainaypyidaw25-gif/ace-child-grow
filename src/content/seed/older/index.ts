...
const NUTRITION_SLEEP_SAFETY: NutritionSleepSafety[] = [
  ['13_18m', 'nutrition',
    b('မိသားစုစားသော အစားအစာအမျိုးမျိုးကို လက်ဖြင့်စား ကြိုးစားခြင်း', 'Eats a variety of family foods with some help'),
    b('ပြုတ်ပြီး အသေးလှီးထားသော မိသားစုအစားအစာကို (အနယ်မဟုတ်ဘဲ) ကိုယ်တိုင် ကောက်စားပါသလား။ ဖွင့်ထားသောခွက်ကို လူကြီးကူညီမှုဖြင့် သောက်ပါသလား။', 'Does your child eat small, soft pieces of family food (not just purees), and drink from an open cup with your help?'),
    b('ဤအရွယ်တွင် အများစုသည် အနယ်ပုံစံမှ အသေးလှီးထားသော အစားအစာများသို့ ကူးပြောင်းနေကြသည်။ ခွက်ဖြင့်သောက်ခြင်းက ပါးစပ်ကြွက်သားများကို ပိုမိုလေ့ကျင့်ပေးသည်။', 'Most toddlers this age are moving from purees to soft chopped family foods, and cup drinking builds oral-motor skill.'),
    b('စားပွဲတွင် မိသားစုနှင့် အတူထိုင်ကျွေးပြီး ကိုယ်တိုင် ကောက်စားခွင့် ပေးပါ — ပက်ကျံခြင်းသည် ပုံမှန်ဖြစ်သည်။', 'Sit your child at the family table and let them try feeding themselves — mess is normal and expected.')],
  ['13_18m', 'sleep',
    b('တစ်ရက်လျှင် နေ့ခင်းအိပ်ချိန် နှစ်ကြိမ်မှ တစ်ကြိမ်သို့ ကူးပြောင်းလာခြင်း', 'Naps twice a day, moving toward one nap'),
    b('နေ့ခင်း နှစ်ကြိမ်အိပ်ပါသလား၊ တစ်ကြိမ်တည်းသာ အိပ်ချင်တော့ပါသလား။ ညအိပ်ချိန် တစ်ညလုံး နီးပါးရှိပါသလား။', 'Does your child still nap twice a day, or seem ready for just one longer nap? Do nights include one longer stretch of sleep?'),
    b('ဤအရွယ်တွင် အိပ်ပုံစံ တဖြည်းဖြည်း ပြောင်းလဲလာပြီး နေ့ခင်း တစ်ကြိမ်အိပ်ချိန်ဆီသို့ ရွေ့လျားလာသည် — ကလေးအလိုက် ကွာဟမှု ကျယ်ပါသည်။', 'Sleep patterns shift now, moving toward a single nap — timing varies widely between children.'),
    b('နေ့ခင်းအိပ်ချိန်နှင့် ညအိပ်ချိန်ကို တတ်နိုင်သမျှ ပုံမှန် ထားပါ။', 'Keep nap and bedtime as consistent as you reasonably can.')],
  ['13_18m', 'safety',
    b('"မလုပ်နဲ့" သို့မဟုတ် အန္တရာယ်ဆိုင်ရာ စကားလုံးကို တစ်ခါတစ်ရံ တုံ့ပြန်ခြင်း', 'Responds to "no" or a danger word, at least sometimes'),
    b('"မလုပ်နဲ့" ဒါမှမဟုတ် "အန္တရာယ်ရှိတယ်" ဟု ပြောလျှင် ရပ်တန့် သို့မဟုတ် လှည့်ကြည့်ပါသလား (အမြဲတမ်း မဟုတ်သော်လည်း)။', 'When you say "no" or "danger," does your child sometimes pause or look at you — even if not every time?'),
    b('ဤအရွယ်တွင် အန္တရာယ်စကားလုံးကို တစ်စိတ်တစ်ပိုင်း နားလည်စတင်သော်လည်း ကိုယ်တိုင် ထိန်းချုပ်နိုင်မှု မရှိသေးပါ — အနီးကပ် ကြီးကြပ်မှု လိုအပ်ဆဲဖြစ်သည်။', 'Understanding of danger words is only beginning now and self-control is not yet reliable — close supervision is still essential.'),
    b('"မလုပ်နဲ့" ပြောရုံထက် ဘေးကင်းသော အစားထိုးလုပ်ဆောင်ချက် ချက်ချင်းပြပါ။', 'Instead of just saying "no," immediately show a safe alternative action.')],

  ['19_24m', 'nutrition',
    b('ဇွန်းကို ပိုမိုကျွမ်းကျင်စွာ သုံးခြင်းနှင့် ဖွင့်ထားသောခွက်ဖြင့် သောက်ခြင်း', 'Uses a spoon with less spilling and drinks from an open cup'),
    b('ဇွန်းဖြင့် အစာကို ပါးစပ်ထိအောင် အများစု ယူဆောင်နိုင်ပါသလား။ ဖွင့်ထားသောခွက်ကို ကိုယ်တိုင် ကိုင်ပြီး သောက်ပါသလား။', 'Can your child get most of a spoonful to the mouth without heavy spilling? Do they hold and drink from an open cup themselves?'),
    b('ဒီအရွယ်တွင် ဇွန်း/ခွက် အသုံးပြုနိုင်မှု ပိုမိုတိကျလာသည် — လက်နှင့်မျက်စိ ညှိနှိုင်းမှု တိုးတက်လာကြောင်း ပြသည်။', 'Spoon and cup use become noticeably more accurate now, showing growing hand–eye coordination.'),
    b('ပက်ကျံမှုကို ခန့်မှန်းထားပြီး ဇွန်းကို ကိုယ်တိုင်သုံးရန် အားပေးဆက်လက်ပါ။', 'Expect some spilling and keep encouraging independent spoon use.')],
  ['19_24m', 'sleep',
    b('တည်ငြိမ်သော အိပ်မီအစီအစဉ်ဖြင့် ပြင်ဆင်နိုင်ခြင်း', 'Settles with a consistent bedtime routine'),
    b('အိပ်မီ တူညီသောအဆင့်များ (ရေချိုး၊ စာဖတ်၊ အိပ်) ကို လိုက်နာပြီး ပြင်ငြိမ်စွာ အိပ်ပျော်ပါသလား။', 'Does your child settle calmly with a familiar bedtime sequence — bath, book, sleep?'),
    b('တူညီသော အဆင့်များကို ထပ်ခါထပ်ခါ လုပ်ခြင်းက ကလေးအား အိပ်ချိန် နီးလာကြောင်း ကြိုတင်သိစေသည်။', 'A repeated sequence signals that sleep is coming, which helps a toddler settle.'),
    b('မျက်နှာပြင်များကို အိပ်မီ ရှောင်ပြီး အလင်းလျှော့ကာ တူညီသောအစီအစဉ်ကို ထိန်းပါ။', 'Avoid screens before bed, dim the lights, and keep the sequence the same each night.')],
  ['19_24m', 'safety',
    b('အသိပေးထားသော အန္တရာယ်ရှိသည့်အရာများကို သတိထားခြင်း', 'Shows caution around things labelled as dangerous'),
    b('"ပူတယ်" သို့မဟုတ် "ထက်တယ်" ဟု ပြောပြီးသော အရာများကို ကြာလာသည်နှင့်အမျှ ဝေးဝေးနေခြင်း သို့မဟုတ် သတိထားခြင်း ရှိလာပါသလား။', 'Over time, does your child start to hold back or show caution around things you have labelled "hot" or "sharp"?'),
    b('ထပ်ခါထပ်ခါ တညီတညွတ်တည်း ပြောပြခြင်းက ကလေးအား ဒီစကားလုံးများကို အန္တရာယ်နှင့် ချိတ်ဆက်စေသည်။', 'Consistent, repeated labelling helps a toddler connect these words with real danger.'),
    b('အန္တရာယ်ရှိသည့်အရာတွေကို တညီတညွတ်တည်း တူညီသောစကားလုံးဖြင့် အမြဲခေါ်ပါ။', 'Use the same word for the same hazard every time, consistently.')],

  ['2y', 'nutrition',
    b('မိသားစုစားပွဲတွင် ကိုယ်တိုင် စားနိုင်သော်လည်း ရွေးချယ်စားတတ်ခြင်း', 'Eats independently at family meals, though may be a picky eater'),
    b('စားပွဲတွင် ကိုယ်တိုင်ထိုင်၍ စားနိုင်ပါသလား။ အစားအစာအချို့ကို ငြင်းဆန်တတ်သော်လည်း တခြားအချို့ကို နှစ်သက်စွာ စားတတ်ပါသလား။', 'Does your child sit and eat mostly independently, even if they refuse some foods while enjoying others?'),
    b('ဤအရွယ်တွင် စားစရာ ရွေးချယ်ခြင်း (picky eating) သည် အလွန်ပုံမှန် ဖြစ်ပြီး ကိုယ်တိုင်ဆန္ဒဖော်ပြနိုင်မှု ကြီးထွားလာခြင်းကို ပြသည်။', 'Picky eating is very common and normal at this age — it reflects a growing sense of independence and preference.'),
    b('အတင်းမကျွေးဘဲ အုပ်စုစုံအစားအစာကို ထပ်ခါထပ်ခါ ဖိအားမပေးဘဲ ဆက်လက်ပေးကြည့်ပါ။', 'Avoid forcing food; keep calmly re-offering a variety without pressure.')],
  ['2y', 'sleep',
    b('ညအိပ်ချိန်များတွင် နိုးမှုနည်းလာခြင်း', 'Sleeps through most nights with fewer wakings'),
    b('ညဘက် တစ်ရေးမျှ နိုးသော်လည်း ကိုယ်တိုင် သို့မဟုတ် အနည်းငယ် နှစ်သိမ့်မှုဖြင့် ပြန်အိပ်ပျော်ပါသလား။', 'If your child wakes briefly at night, do they settle back to sleep on their own or with only brief comforting?'),
    b('ဤအရွယ်တွင် ညဘက် အိပ်ချိန် ရှည်လာပြီး ပြန်အိပ်ပျော်နိုင်မှု တိုးလာသည် — ကျန်းမာသော ကလေးများပင် တစ်ခါတစ်ရံ နိုးနိုင်သည်။', 'Night sleep stretches lengthen now, though even healthy children can still wake occasionally.'),
    b('ညဘက်နိုးလျှင် တိတ်ဆိတ်၍ ငြိမ်သက်စွာ တုံ့ပြန်ပါ — အလင်း၊ ကစားခြင်း မလုပ်ပါနှင့်။', 'If your child wakes at night, respond quietly and calmly — avoid lights or play.')],
  ['2y', 'safety',
    b('ရိုးရှင်းသော ဘေးကင်းရေးစည်းမျဉ်းတစ်ခုကို တစ်ခါတစ်ရံ လိုက်နာခြင်း', 'Sometimes follows one simple safety rule'),
    b('"လမ်းမပေါ်တွင် လက်ကိုင်ထားပါ" ကဲ့သို့ စည်းမျဉ်းကို အသိပေးထားပါက တစ်ခါတစ်ရံ လိုက်နာပါသလား။', 'When reminded, does your child sometimes follow a rule like "hold my hand near the road"?'),
    b('စကားနားလည်မှု တိုးလာသောကြောင့် ရိုးရှင်းသောစည်းမျဉ်းတစ်ခုကို ခဏတာ လိုက်နာနိုင်လာသော်လည်း အမြဲတမ်း မမျှော်လင့်နိုင်ပါ။', 'Growing language lets a toddler follow one simple rule briefly, but it cannot be relied on every time yet.'),
    b('စည်းမျဉ်းတစ်ခုကို အကြိမ်ကြိမ် တူညီသောစကားလုံးဖြင့် ထပ်ခါပြောပါ။', 'Repeat the same rule using the same words, again and again.')],

  ['2_5y', 'nutrition',
    b('အစားအစာအသစ်ကို ထပ်ခါစမ်းကြည့်ခြင်းဖြင့် လက်ခံလာနိုင်ခြင်း', 'Tries new foods with repeated, low-pressure offers'),
    b('အစားအစာအသစ်တစ်ခုကို ပထမတွင် ငြင်းဆန်သော်လည်း အကြိမ်ကြိမ် ထပ်ပေးကြည့်ပါက တစ်ခါတစ်ရံ စမ်းကြည့်ပါသလား။', 'Does your child sometimes try a new food after it has been calmly offered several times, even if they refused it at first?'),
    b('အစားအစာအသစ်တစ်ခုကို လက်ခံရန် အကြိမ်များစွာ (၈–၁၀ ကြိမ်ခန့်) ကြည့်ရှုရသည်မှာ ပုံမှန်ဖြစ်သည်။', 'It commonly takes many exposures — around 8 to 10 — before a child accepts a new food, and that is normal.'),
    b('ဖိအားမပေးဘဲ ပုံမှန် ထပ်ပေးကြည့်ပါ။ မိဘကိုယ်တိုင် စားပြခြင်းက အထောက်အကူဖြစ်သည်။', 'Keep offering without pressure, and model eating the food yourself — it helps.')],
  ['2_5y', 'sleep',
    b('နေ့ခင်း တစ်ကြိမ်အိပ်ချိန်ဆီသို့ ကူးပြောင်းပြီး အိပ်ချိန်တွင် ခုခံတတ်ခြင်း', 'Settled into one nap, may resist bedtime'),
    b('နေ့ခင်းတွင် တစ်ကြိမ်တည်းသာ အိပ်ပါသလား။ အိပ်ရမည့်အချိန်ကျရင် "မအိပ်သေးဘူး" ဟု ခုခံတတ်ပါသလား။', 'Does your child nap only once a day now? Do they sometimes resist or delay going to bed?'),
    b('ဤအရွယ်တွင် လွတ်လပ်မှုဆန္ဒ ပိုကြီးလာသဖြင့် အိပ်ချိန်ကို ခုခံတတ်ခြင်းသည် အလွန်ပုံမှန် ဖြစ်သည်။', 'Bedtime resistance is very common now as independence and opinions grow stronger.'),
    b('ရွေးချယ်စရာ ၂ ခုပေးပါ ("ဒီစာအုပ် ဒါမှမဟုတ် ဟိုစာအုပ်") — ထိန်းချုပ်မှု အနည်းငယ်ခံစားစေပါ။', 'Offer two small choices ("this book or that one?") so bedtime feels a little more in their control.')],
  ['2_5y', 'safety',
    b('အန္တရာယ်ရှိသည့်အရာအချို့ကို မေးလျှင် အမည်ခေါ်နိုင်ခြင်း', 'Names a few dangerous things when asked'),
    b('"ဘာက အန္တရာယ်ရှိလဲ" ဟုမေးလျှင် မီး၊ ဓားလား လမ်းမလို အရာတစ်ခုခုကို ပြောနိုင်ပါသလား။', 'If asked "what is dangerous?", can your child name something like fire, a knife, or the road?'),
    b('အန္တရာယ်ရှိသောအရာများကို စကားဖြင့် သိရှိခြင်းက စည်းမျဉ်းများနောက်ကွယ်က အကြောင်းရင်းကို စတင် နားလည်လာကြောင်း ပြသည်။', 'Naming hazards in words shows the beginning of understanding why the rules exist.'),
    b('အန္တရာယ်ရှိသောအရာကို တွေ့တိုင်း တိတ်တိတ်ဆိတ်ဆိတ် အမည်ခေါ်ပြပါ။', 'Quietly name the hazard out loud every time you encounter one together.')],
  ...
  ['3_5y', 'nutrition',
    b('စားပွဲတွင် ထိုင်ပြီး အစားအစာအချိန်ကို လိုက်နာနိုင်ခြင်း', 'Sits through a family meal at the table'),
    b('မိသားစုစားပွဲအချိန်ကို အစအဆုံး (မိနစ်အနည်းငယ်ခန့်) ထိုင်ပြီး ပါဝင်နိုင်ပါသလား။', 'Can your child sit and take part through most of a family meal, for at least several minutes?'),
    b('စားပွဲတွင် ထိုင်ခြင်းသည် ကိုယ်ထိန်းချုပ်မှုနှင့် မိသားစုပုံမှန်လုပ်ရိုးလုပ်စဉ်ကို လက်ခံနိုင်မှုကို ပြသည်။', 'Sitting through a meal shows growing self-regulation and comfort with family routines.'),
    b('စားပွဲအချိန်ကို တိုတောင်း၍ စိတ်ချမ်းသာအောင် ထားပြီး စကားပြောခြင်းနှင့် ရောယှက်ပါ။', 'Keep mealtimes reasonably short and relaxed, with conversation woven in.')],
  ['3_5y', 'sleep',
    b('အိပ်မီအစီအစဉ်ရဲ့ အဆင့်များကို သိရှိပြီး မျှော်လင့်တတ်ခြင်း', 'Names parts of the bedtime routine and anticipates them'),
    b('အိပ်မီအစီအစဉ်တွင် နောက်လာမည့်အဆင့်ကို ကြိုပြောနိုင်ပါသလား ("ရေချိုးပြီးရင် စာဖတ်မယ်")။', 'Can your child tell you what comes next in the bedtime routine — "after bath, we read a book"?'),
    b('အစီအစဉ်ကို သိရှိခြင်းသည် ကလေးအား ထိန်းချုပ်မှုခံစားရစေပြီး အိပ်ရာဝင်ရန် ပိုလွယ်ကူစေသည်။', 'Knowing the routine gives a child a sense of control and makes bedtime easier.'),
    b('ပုံစာအနည်းငယ်ပါသော အစီအစဉ်ဇယားလေး ပြသပြီး ကလေးကိုယ်တိုင် လိုက်နာစေပါ။', 'Show a simple picture routine chart and let your child follow it themselves.')],
  ['3_5y', 'safety',
    b('အရေးပေါ်တွင် ယုံကြည်ရသော လူကြီးတစ်ဦးကို ခေါ်ရန် သိရှိခြင်း', 'Knows to call a trusted adult when something feels wrong'),
    b('ခြေထိခိုက်လျှင် သို့မဟုတ် ကြောက်စရာဖြစ်လျှင် လူကြီးကို ချက်ချင်း အသိပေးပါသလား။', 'When hurt or frightened, does your child come to tell a trusted adult right away?'),
    b('အကူအညီတောင်းရန် သိရှိခြင်းသည် ကိုယ်ပိုင်ဘေးကင်းရေး ကျွမ်းကျင်မှု၏ အရေးကြီးသော အစိတ်အပိုင်းတစ်ခု ဖြစ်သည်။', 'Knowing to seek help is an important part of self-protective safety skill.'),
    b('"တစ်ခုခုမှားနေလို့ထင်ရင် ငါ့ဆီလာပြောပါ" ဟု ရိုးရှင်းစွာ ပြောပြထားပါ။', 'Simply and clearly tell your child, "if something feels wrong, come tell me."')],
  ...
  ['4y', 'sleep',
    ...
    b('ဒီအရွယ်တွင် ညဘက်တစ်ခါတစ်ရံ ကြောက်ခြင်း (dreams, dark) ဖြစ်နိုင်သော်လည်း ကိုယ်ပိုင်အိပ်ရာတွင် အိပ်နိုင်မှု ခိုင်မာလာသည်။', 'Occasional nighttime fears (dreams, the dark) are common now, but sleeping in their own bed becomes more established.'),
    b('အလင်းအနည်းငယ်ပါ nightlight တစ်ခုနှင့် ရင်းနှီးသော အိပ်ချောင်းရှင် ပေးထားခြင်းက ကူညီနိုင်သည်။', 'A dim nightlight and a familiar comfort item can help with occasional nighttime fears.')],
  ['4y', 'safety',
