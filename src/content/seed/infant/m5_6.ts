  ...
  kb(
    guide('5_6m', 'safety', {
      ...
      safety: b(
        ...
        'Never leave her alone on a bed, table or sofa, even for a second. Never leave her alone near water — baths, buckets and ponds all count. Remove anything small enough to fit her mouth, including coins, buttons, marbles, nuts and button batteries. Keep long cords, blind pulls and plastic bags out of reach. Keep hot drinks, cooking pots and stoves away from her. Lock away chemicals, medicines and fuel. In a vehicle, use a rear-facing child restraint that meets the standard. No tobacco smoke near her. Never shake a baby. Keep immunisations up to date.',
      ),
      commonMistakes: [
