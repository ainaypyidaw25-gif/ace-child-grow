...
const ACTIVITIES: SeedItem[] = [
  ...
  kb(
    activity({
      ...
      title: b('ရုပ်စုံစာအုပ်ထူထူ လက်ညှိုးထိုး ကစားခြင်း', 'Board book pointing'),
      summary: b('ရုပ်စုံစာအုပ်ထူထူကို အတူဖတ်ရင်း ပုံများကို လက်ညှိုးထိုး အမည်ခေါ်ခြင်း။', 'Share a board book, point at the pictures and name them.'),
      ageGroupKey: '5_6m',
