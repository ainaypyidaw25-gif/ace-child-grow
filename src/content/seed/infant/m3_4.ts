...
const GUIDES_D: SeedItem[] = [
  kb(
    guide('3_4m', 'nutrition', {
      ...
      safety: b(
        'အသက် ၆ လမပြည့်မီ ရေ၊ ဆန်ပြုတ်နှင့် နွားနို့ မပေးပါနှင့်။ အသက် ၁၂ လမပြည့်မီ ပျားရည်ပေးခြင်းက ပြင်းထန်သော အဆိပ်သင့်မှု ဖြစ်စေနိုင်သဖြင့် လုံးဝ မပေးပါနှင့်။ နို့ဗူးကို ထောက်ထားပြီး ကလေးကို တစ်ယောက်တည်း မထားပါနှင့်။ နို့သီးပြီး အသက်ရှူလမ်းကြောင်း ပိတ်ဆို့နိုင်သည်။ နို့မှုန့်သုံးပါက ထုတ်လုပ်သူ၏ ညွှန်ကြားချက်အတိုင်း အတိအကျ ဖျော်ပါ။',
