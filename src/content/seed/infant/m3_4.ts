...
const GUIDES: SeedItem[] = [
  ...
  kb(
    guide('3_4m', 'fine_motor', {
      ...
      why: b(
        'လက်များသည် လက်သီးဆုပ်ထားခြင်းမှ ဖြန့်လာပြီး ရင်ဘတ်အလယ်တွင် ဆုံစည်းလာသည်။ ကလေးသည် မိမိလက်ကို စိုက်ကြည့်တတ်သည် (hand regard)၊ ပစ္စည်းကို လှမ်းပုတ်ရန် ကြိုးစားတတ်သည်။ ကိုင်မိလျှင် ပါးစပ်ထဲ ထည့်ခြင်းသည် ပုံမှန် သင်ယူမှု ဖြစ်သည်။',
...
const GUIDES_B: SeedItem[] = [
  ...
  kb(
    guide('3_4m', 'social', {
      ...
      why: b(
        'ဤအရွယ်တွင် ကလေးသည် လူကို မြင်လျှင် ပြုံးတတ်သည် (social smile)။ အသိမျက်နှာများကို ပိုမှတ်မိလာပြီး လူများနှင့် အတူနေရသည်ကို နှစ်သက်တတ်သည်။ တစ်ယောက်တည်း ကျန်ခဲ့လျှင် ငိုတတ်သည် — ဤသည် အလိုလိုက်လွန်းခြင်း မဟုတ်ဘဲ ဆက်နွယ်မှု ဖွံ့ဖြိုးနေခြင်း ဖြစ်သည်။',
...
const GUIDES_D: SeedItem[] = [
  kb(
    guide('3_4m', 'nutrition', {
      ...
      safety: b(
        'အသက် ၆ လမပြည့်မီ ရေ၊ ဆန်ပြုတ်၊ နွားနို့ မပေးပါနှင့်။ ပျားရည်ကို အသက် ၁၂ လအောက် လုံးဝ မပေးပါနှင့် — botulism ဖြစ်နိုင်သည်။ နို့ဗူးကို မှီပေးထား၍ တစ်ယောက်တည်း မထားပါနှင့် — လည်ချောင်းပိတ်နိုင်သည်။ နို့မှုန့် သုံးပါက ညွှန်ကြားချက်အတိုင်း အတိအကျ ဖျော်ပါ။',
