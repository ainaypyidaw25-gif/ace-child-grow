...
describe('Myanmar copy quality', () => {
  ...
  it('keeps the second reviewer language batch on its exact milestone records', () => {
    const expectedTitles = new Map<string, string>([
      ...
      ['ms_2_5y_social_3', 'အခြား ကလေးများနှင့် ဘေးချင်းယှဉ် ကစားရုံသာမက အတူတကွ ပူးပေါင်းကစားတတ်လာခြင်း'],
      ...
      ['ms_3_4m_social_2', 'ရိုးရှင်းသော မျက်နှာအမူအရာများကို လိုက်လံ အတုယူပြုမူခြင်း'],
