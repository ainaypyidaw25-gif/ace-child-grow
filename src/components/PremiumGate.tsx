  ...
  return (
    <section className="mx-auto max-w-xl overflow-hidden rounded-[30px] border border-sky/20 bg-white shadow-card">
      <div className="bg-ink px-6 py-8 text-white">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-mint">{nativeStoreBuild ? 'ACE Child Grow' : 'ACE Premium'}</p>
        <h1 className="mt-3 text-2xl font-bold">
          {nativeStoreBuild
            ? locale === 'mm' ? 'ဤဝန်ဆောင်မှုကို လက်ရှိ Store release တွင် မထည့်သွင်းထားသေးပါ' : 'This feature is not included in the current Store release'
