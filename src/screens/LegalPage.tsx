    ...
    return (
      <PublicLegalShell title="စစ်ဆေးစာရင်း အသုံးပြုပုံ" titleEn="How the milestone guidance works">
        ...
        <LegalSection title="ကျွမ်းကျင်မှု ပြန်လည်လျော့နည်းခြင်း / Loss of a previously acquired skill">
          ယခင်လုပ်နိုင်ခဲ့သော ကျွမ်းကျင်မှုတစ်ခု မလုပ်နိုင်တော့ကြောင်း မှတ်သားပါက ကလေးကျန်းမာရေး သို့မဟုတ် ဖွံ့ဖြိုးရေးဆိုင်ရာ ကျွမ်းကျင်ပညာရှင်ကို အမြန်ဆုံး ဆက်သွယ်အကဲဖြတ်ရန် အကြံပြုပါသည်။ အရေးပေါ်လက္ခဏာကို သီးခြားတွေ့ရှိမှသာ အရေးပေါ်စောင့်ရှောက်မှု လမ်းညွှန်ချက်ကို ပြပါသည်။<br />
          A reported loss of a previously acquired skill prompts a recommendation for timely assessment by a qualified child-health or developmental professional. Emergency-care guidance appears only when an acute emergency sign is separately reported.
        </LegalSection>
