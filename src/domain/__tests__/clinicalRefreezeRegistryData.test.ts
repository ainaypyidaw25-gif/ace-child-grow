...
describe('clinical newborn refreeze registry data', () => {
  ...
  it('keeps a strict refreeze then nutrition then safety release chain', async () => {
    ...
    expect(releases.map((row) => ({
      ...
      {
        sequence: 14,
        batchId: 'clinical-evidence-successor-14-2026-09-01-v1',
        activation: 'after_handoff',
        predecessor: 'clinical-english-successor-14-2026-08-31-v1',
      },
      {
        sequence: 15,
        batchId: 'clinical-safety-successor-14-2026-09-01-v1',
        activation: 'after_handoff',
