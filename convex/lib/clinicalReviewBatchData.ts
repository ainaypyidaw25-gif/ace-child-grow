...
} from './clinicalNativeMyanmarRefreezeBatchData';
import {
...
} from './clinicalEnglishRefreezeBatchData';
import {
...
} from './clinicalChildDevelopmentBatchData';
import {
...
} from './clinicalChildDevelopmentRefreezeBatchData';
import {
...
} from './clinicalNativeMyanmarSuccessorBatchData';
import {
...
} from './clinicalEnglishSuccessorBatchData';
import {
...
} from './clinicalEvidenceSuccessorBatchData';
import {
...
} from './clinicalSafetySuccessorBatchData';
import {
...
} from './clinicalReviewSuccessorBatchData';
...
export {
  ...
  CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_MANIFEST,
  CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_PREIMAGES,
  CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_REVIEWER,
  CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_ROUTING_HASH,
  CLINICAL_NATIVE_MYANMAR_REFREEZE_DECISION_SET_DIGEST,
  CLINICAL_NATIVE_MYANMAR_REFREEZE_PREVIOUS_BATCH_ID,
} from './clinicalNativeMyanmarRefreezeBatchData';
...
export {
  ...
  CLINICAL_ENGLISH_RELEASE_BATCH_ROUTING_HASH,
  CLINICAL_ENGLISH_RELEASE_PREVIOUS_BATCH_ID,
...
export {
  ...
  CLINICAL_ENGLISH_REFREEZE_BATCH_MANIFEST,
  CLINICAL_ENGLISH_REFREEZE_BATCH_PREIMAGES,
  CLINICAL_ENGLISH_REFREEZE_BATCH_REVIEWER,
  CLINICAL_ENGLISH_REFREEZE_BATCH_ROUTING_HASH,
  CLINICAL_ENGLISH_REFREEZE_DECISION_SET_DIGEST,
  CLINICAL_ENGLISH_REFREEZE_PREVIOUS_BATCH_ID,
} from './clinicalEnglishRefreezeBatchData';
...
export {
  ...
  CLINICAL_CHILD_DEVELOPMENT_RELEASE_BATCH_ROUTING_HASH,
  CLINICAL_CHILD_DEVELOPMENT_RELEASE_PREVIOUS_BATCH_ID,
...
export const CLINICAL_REVIEW_BATCH_REGISTRY = [
  ...
  },
  {
    ...
    routingCanonicalSha256: CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_ROUTING_HASH,
    ...
    manifest: CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_MANIFEST,
  },
  {
    sequence: 8,
    laneGraphVersion: 1,
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_NATIVE_MYANMAR_REFREEZE_BATCH_HASH,
    },
    routingCanonicalSha256: CLINICAL_ENGLISH_RELEASE_BATCH_ROUTING_HASH,
    ...
    manifest: CLINICAL_ENGLISH_RELEASE_BATCH_MANIFEST,
  },
  {
    sequence: 9,
    laneGraphVersion: 1,
    ...
    activation: {
      kind: 'after_changes_requested_refreeze',
      previousBatchId: CLINICAL_ENGLISH_RELEASE_BATCH_MANIFEST.batchId,
      expectedDecisionSetDigest: CLINICAL_ENGLISH_REFREEZE_DECISION_SET_DIGEST,
    },
    routingCanonicalSha256: CLINICAL_ENGLISH_REFREEZE_BATCH_ROUTING_HASH,
    ...
    manifest: CLINICAL_ENGLISH_REFREEZE_BATCH_MANIFEST,
  },
  {
    sequence: 10,
    laneGraphVersion: 1,
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_ENGLISH_REFREEZE_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_ENGLISH_REFREEZE_BATCH_HASH,
    },
    routingCanonicalSha256: CLINICAL_CHILD_DEVELOPMENT_RELEASE_BATCH_ROUTING_HASH,
    ...
    manifest: CLINICAL_CHILD_DEVELOPMENT_RELEASE_BATCH_MANIFEST,
  },
  {
    sequence: 11,
    laneGraphVersion: 1,
    ...
    activation: {
      kind: 'after_changes_requested_refreeze',
      previousBatchId: CLINICAL_CHILD_DEVELOPMENT_RELEASE_BATCH_MANIFEST.batchId,
  ...
  },
  {
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_CHILD_DEVELOPMENT_REFREEZE_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_CHILD_DEVELOPMENT_REFREEZE_BATCH_HASH,
    },
  ...
  },
  {
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_NATIVE_MYANMAR_SUCCESSOR_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_NATIVE_MYANMAR_SUCCESSOR_BATCH_HASH,
    },
  ...
  },
  {
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_ENGLISH_SUCCESSOR_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_ENGLISH_SUCCESSOR_BATCH_HASH,
    },
  ...
  },
  {
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_EVIDENCE_SUCCESSOR_BATCH_MANIFEST.batchId,
      expectedPreviousFreezeDigest: CLINICAL_EVIDENCE_SUCCESSOR_BATCH_HASH,
    },
  ...
  },
  {
    ...
    activation: {
      kind: 'after_handoff',
      previousBatchId: CLINICAL_SAFETY_SUCCESSOR_BATCH_MANIFEST.batchId,
