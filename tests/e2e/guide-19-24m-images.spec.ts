...
const GUIDES = [
  ['gd_19_24m_daily_routine', '၁၉–၂၄ လ — နေ့စဉ်လုပ်ရိုးလုပ်စဉ် လမ်းညွှန်', '19–24 months — daily routine guide', '/guides/gd_19_24m_daily_routine.dee4891324.webp'],
  ['gd_19_24m_nutrition', '၁၉–၂၄ လ — အာဟာရ လမ်းညွှန်', '19–24 months — nutrition guide', '/guides/gd_19_24m_nutrition.caafec249d.webp'],
  ['gd_19_24m_safety', '၁၉–၂၄ လ — ဘေးကင်းလုံခြုံရေး လမ်းညွှန်', '19–24 months — safety guide', '/guides/gd_19_24m_safety.3e762eb8c3.webp'],
  ['gd_19_24m_sleep', '၁၉–၂၄ လ — အိပ်စက်ခြင်း လမ်းညွှန်', '19–24 months — sleep guide', '/guides/gd_19_24m_sleep.106f76d450.webp'],
  ['gd_19_24m_speech', '၁၉–၂၄ လ — စကားသံ ထွက်ဆိုမှု', '19–24 months — Speech', '/guides/gd_19_24m_speech.00e0c08e9d.webp'],
] as const;

const screenshotDir = resolve(
  process.cwd(),
  'docs/illustration-review/screenshots/guides-19_24m',
);
...
test('serves all 5 exact 19–24 month guide assets and captures text-image review cards', async ({ page, request }) => {
  ...
  expect(new Set(GUIDES.map(([, , , asset]) => asset)).size).toBe(5);
