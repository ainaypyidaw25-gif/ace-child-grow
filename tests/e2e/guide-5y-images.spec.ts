...
const GUIDES = [
  ['gd_5y_daily_routine', '၅ နှစ် — နေ့စဉ်လုပ်ရိုးလုပ်စဉ် လမ်းညွှန်', '5 years — daily routine guide', '/guides/gd_5y_daily_routine.a8bef9fde0.webp'],
  ['gd_5y_nutrition', '၅ နှစ် — အာဟာရ လမ်းညွှန်', '5 years — nutrition guide', '/guides/gd_5y_nutrition.ba81d83df8.webp'],
  ['gd_5y_safety', '၅ နှစ် — ဘေးကင်းလုံခြုံရေး လမ်းညွှန်', '5 years — safety guide', '/guides/gd_5y_safety.610b5aeca8.webp'],
  ['gd_5y_sleep', '၅ နှစ် — အိပ်စက်ခြင်း လမ်းညွှန်', '5 years — sleep guide', '/guides/gd_5y_sleep.89936421f7.webp'],
] as const;

const screenshotDir = resolve(
  process.cwd(),
  'docs/illustration-review/screenshots/guides-5y',
);
...
test('serves all 4 exact 5-year guide assets and captures text-image review cards', async ({ page, request }) => {
