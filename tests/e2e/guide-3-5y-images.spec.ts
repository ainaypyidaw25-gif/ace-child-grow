...
const GUIDES = [
  ['gd_3_5y_daily_routine', '၃ နှစ်ခွဲ — နေ့စဉ်လုပ်ရိုးလုပ်စဉ် လမ်းညွှန်', '3.5 years — daily routine guide', '/guides/gd_3_5y_daily_routine.52c15c6500.webp'],
  ['gd_3_5y_nutrition', '၃ နှစ်ခွဲ — အာဟာရ လမ်းညွှန်', '3.5 years — nutrition guide', '/guides/gd_3_5y_nutrition.a9bb6fe8f1.webp'],
  ['gd_3_5y_safety', '၃ နှစ်ခွဲ — ဘေးကင်းလုံခြုံရေး လမ်းညွှန်', '3.5 years — safety guide', '/guides/gd_3_5y_safety.9293fe1354.webp'],
  ['gd_3_5y_sleep', '၃ နှစ်ခွဲ — အိပ်စက်ခြင်း လမ်းညွှန်', '3.5 years — sleep guide', '/guides/gd_3_5y_sleep.da3b8b7d22.webp'],
] as const;

const screenshotDir = resolve(
  process.cwd(),
  'docs/illustration-review/screenshots/guides-3_5y',
);
...
test('serves all 4 exact 3.5-year guide assets and captures text-image review cards', async ({ page, request }) => {
